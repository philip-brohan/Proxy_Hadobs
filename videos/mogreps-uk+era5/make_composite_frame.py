...
# Composite mogreps-uk and ERA5 plots into a single figure.
...
parser.add_argument(
    ...
    default="%s/images/opfc_M+E_uk_3var_composite" % os.getenv("SCRATCH"),
    type=str,
    required=False,
)
...
# Add the ERA5 image to the background
fcst = Image.open(
    "%s/images/opfc_ERA5_uk_3var/%04d%02d%02d%02d%02d.png"
...
# Add the MOGREPS image to the background
ncst = Image.open(
